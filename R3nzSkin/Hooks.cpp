...
namespace d3d_vtable {
	...
	static void init_imgui(IDXGISwapChain* device) noexcept
	{
		...
		colors[ImGuiCol_Border] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		...
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.78f, 0.12f, 0.23f, 0.30f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.15f, 0.15f, 0.16f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		...
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.90f, 0.18f, 0.30f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.18f, 0.18f, 0.19f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.60f, 0.08f, 0.18f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.18f, 0.18f, 0.19f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.60f, 0.08f, 0.18f, 1.00f);
		...
		colors[ImGuiCol_TabHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
