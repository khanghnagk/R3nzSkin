...
namespace d3d_vtable {
	...
	static void init_imgui(IDXGISwapChain* device) noexcept
	{
		...
		colors[ImGuiCol_Border] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		...
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.78f, 0.12f, 0.23f, 0.30f); // Semi-transparent Crimson
		colors[ImGuiCol_TitleBg] = ImVec4(0.15f, 0.15f, 0.16f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.15f, 0.15f, 0.16f, 0.75f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.15f, 0.15f, 0.16f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.12f, 0.12f, 0.13f, 0.80f);
		...
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_CheckMark] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_SliderGrab] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.90f, 0.18f, 0.30f, 1.00f); // Light Crimson
		colors[ImGuiCol_Button] = ImVec4(0.18f, 0.18f, 0.19f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_ButtonActive] = ImVec4(0.60f, 0.08f, 0.18f, 1.00f); // Dark Crimson
		colors[ImGuiCol_Header] = ImVec4(0.18f, 0.18f, 0.19f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_HeaderActive] = ImVec4(0.60f, 0.08f, 0.18f, 1.00f); // Dark Crimson
		colors[ImGuiCol_Separator] = ImVec4(0.20f, 0.20f, 0.22f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.90f, 0.18f, 0.30f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.20f, 0.20f, 0.22f, 1.00f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.90f, 0.18f, 0.30f, 1.00f);
		colors[ImGuiCol_Tab] = ImVec4(0.15f, 0.15f, 0.16f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_TabActive] = ImVec4(0.78f, 0.12f, 0.23f, 1.00f); // Crimson
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.12f, 0.12f, 0.13f, 0.97f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.15f, 0.15f, 0.16f, 1.00f);
		...
		originalWndProc = WNDPROC(::SetWindowLongPtrW(cheatManager.memory->window, GWLP_WNDPROC, reinterpret_cast<LONG_PTR>(wndProc)));
